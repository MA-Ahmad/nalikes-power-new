...
export default function Banner() {
  return (
    <section
      className="relative w-full bg-cover bg-center flex items-center justify-center overflow-hidden rounded-2xl"
    ...
    >
      ...
      />
      <div className=" z-10 flex flex-col lg:flex-row justify-center md:justify-between items-center w-full sm:gap-4 py-4 absolute px-4 md:px-8 lg:px-12 ">
        {/* Left Section */}
        ...
        <div className="flex flex-col items-center md:items-start text-center md:text-right sm:space-y-3">
          ...
          <div className=" space-x-2 md:space-x-0 hidden sm:flex">
