      ...
      <div className="relative z-10 flex flex-col lg:flex-row justify-center md:justify-between items-center w-full gap-4 py-4">
        ...
        <div className="flex flex-col items-center md:items-start text-center md:text-left space-y-3">
          ...
          <div className="flex flex-row items-center space-x-10 mt-3">
            ...
            <Link
              href="#"
              className="items-center justify-center hidden sm:inline-flex lg:px-5 lg:py-2.5 px-3 py-1.5 rounded-lg text-white font-semibold text-base bg-[linear-gradient(to_right,_#6A2A97_0%,_#C753FD_53%,_#FA96FF_100%)] shadow-lg hover:opacity-90 transition-opacity"
            >
