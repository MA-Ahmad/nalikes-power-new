...
export default function PostLaunch() {
  ...
  // Filter by type and limit to 4 items
  const insaneDrops = mysteryBoxes
    .filter((box) => box.type.toLowerCase() === 'insane')
    .slice(0, 4)

  const madDrops = mysteryBoxes
    .filter((box) => box.type.toLowerCase() === 'mad')
    .slice(0, 4)
