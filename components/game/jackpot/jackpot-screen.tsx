  ...
  return (
    <div className="absolute inset-0 flex flex-col justify-between text-white z-10 p-[0.975rem] px-6">
      <div className="mt-6 flex flex-col gap-6 mx-10">
        <div className="flex items-center w-full justify-between gap-2 z-[55]">
          ...
          <div className="flex items-center gap-3">
            <ButtonLightPurple onClick={() => setScreen('how-to-play')}>
              <span className="relative text-purple-base font-semibold whitespace-nowrap flex items-center justify-center">
                <svg
                  width="25"
                  height="25"
                ...
                >
                  <path
                    d="M12.8544 16.1305V11.711M12.8485 8.58698V8.52197"
                    stroke="#96A3F6"
                  ...
                  />
                  <path
                    d="M12.8485 21.5852C7.73904 21.5852 3.59766 17.4428 3.59766 12.3344C3.59766 7.22488 7.73904 3.0835 12.8485 3.0835C17.958 3.0835 22.0994 7.22488 22.0994 12.3344C22.0994 15.914 20.0658 19.0194 17.0907 20.5574"
                    stroke="#96A3F6"
                    stroke-width="1.54181"
                    stroke-linecap="round"
                    stroke-linejoin="round"
      ...
      <div className="z-10 p-[0.975rem] px-10 w-full flex items-center gap-2 justify-between">
        <JackpotGlowBox />

        <TimerBox />
      </div>

      <div className="z-10 p-[0.975rem] px-6 w-full flex flex-col gap-2 justify-center">
        <p className="text-xl text-center">Last Result:</p>
...
export function JackpotGlowBox({
  ...
  return (
    <div className={`relative w-full max-w-lg ${className}`}>
      ...
      {/* Main container */}
      <div
        className="rounded-2xl bg-[#3D3D1F] border-2 border-[#FDC61C] p-8 pt-12 text-center"
        style={{
          boxShadow: `
